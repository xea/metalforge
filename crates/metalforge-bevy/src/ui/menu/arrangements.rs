...
pub fn setup_arrangement(mut commands: Commands, mut menu_state: ResMut<MenuState>, library: Res<LibraryView>) {
    ...
    setup_menu("Arrangements", menu_items, OnArrangements, commands, menu_state);
}